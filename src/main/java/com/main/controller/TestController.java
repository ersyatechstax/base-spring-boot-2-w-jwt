...
public class TestController {
    ...
    public ResponseEntity<ResponsePageVO> findAll(
        ...
        AbstractPageRequestHandler handler = new AbstractPageRequestHandler() {
            @Override
            public Page processRequest() {
                return testService.findAll(page,limit,sortBy,sortDirection);
            }
        };
        return handler.constructPageResult();
    }
...
//
//    public ResponseEntity<ResponsePageVO> constructPageResult(Page page){
//        return AbstractRequestHandler.constructPageResult(page);
//    }
}
